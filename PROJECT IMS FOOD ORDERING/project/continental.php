...
<div class="row">
	...
	<div class="panel panel-default">
      ...
      <img src="images/moti_mahal.jpg" alt="Moti Mahal Deluxe" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 >Moti Mahal Deluxe</h3>
        <p>
        	<address>
        	Bhupindra Rd,<br/>
          Model Town,<br/>
        ...
        <p><a href="moti_mahal.php?rest_id=11&categ_id=2" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
  </div>
    </div>
  </div>
	...
	<div class="panel panel-default">
		<div class="panel-body">
		<img src="images/yellow_chilli.jpg" alt="Yellow Chilli" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 style="position:center">Yellow Chilli</h3>
        <p>
        	<address>
        	1, Stadium Road,<br/>
          In Front Of YPS,<br/>
        ...
        <p><a href="yellow_chilli.php?rest_id=12&categ_id=2" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
    </div>
  </div>
</div>
