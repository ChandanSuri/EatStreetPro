    ...
    <div class="container" style="align:center ; width:480px;">
      <div class="row">
        ...
        <DIV class="col-md-4 no-margin no-padding">
              <img src="images/dominos1.jpg" style=" margin-top:10px; height:150px; width:200px; z-index: -1;" class="img-responsive">
            </div>
        </DIV>
      </div>
    </div>
          ...
          <div class="panel panel-default">
            ...
            <DIV class="panel-body">
              ...
              <div class="form-group">
                ...
                <tr>
                  <tVeg Spech colspan="3" class="success"><u><i>Veg Special</i></u></th>
                </tr>
                <tr>
