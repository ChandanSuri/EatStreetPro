...
<div class="row">
	...
	<div class="panel panel-default">
      ...
      <img src="images/shree_rathnam.jpg" alt="Shree Rathnam" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 >Shree Rathnam</h3>
        <p>
        	<address>
        	Hotel Jiwan Plaza,<br/>
          Bhupindra Road,<br/>
          Patiala, Punjab 147004.
        	</address>
        </p>
        <p><a href="shree Rathnam.php?rest_id=14&categ_id=3" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
  </div>
    </div>
  </div>
	...
	<div class="panel panel-default">
      ...
      <div class="caption">
        ...
        <p><a href="gopal.php?rest_id=15&categ_id=3" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="panel panel-default">
		<div class="panel-body">
        <img src="images/madrasi.jpg" alt="Madrasi" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 style="position:center">Madrasi Restaurant</h3>
        <p>
        	<address>
        	 Vikas Vihar,<br/>
           Prem Nagar,<br/>
        ...
        <p><a href="madrasi.php?rest_id=16&categ_id=3" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
    </div>
  </div>
</div>
