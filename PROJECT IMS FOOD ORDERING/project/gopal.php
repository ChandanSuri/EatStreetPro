    ...
    <div class="container" style="align:center ; width:480px;">
      <div class="row">
        ...
        <DIV class="col-md-4 no-margin no-padding">
              <img src="images/gopal2.png" style="margin-top:10px; height:150px; width:200px; z-index: -1;" class="img-responsive">
            </div>
        </DIV>
      </div>
    </div>
          ...
          <div class="panel panel-default">
            ...
            <DIV class="panel-body">
              ...
              <div class="form-group">
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="White Sauce/175"><strong> White Sauce</strong></td>
                <td>RS 175.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0 ></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Concasse Sauce/175"><strong> Concasse Sauce</strong></td>
                <td>RS 175.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Cream Concasse Sauce/175"><strong> Cream Concasse Sauce</strong></td>
                <td>RS 175.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Veg Grilled Sandwiches/125"><strong> Veg Grilled Sandwiches</strong></td>
                <td>RS 125.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Mushroom And Cheese/125"><strong> Mushroom and Cheese</strong></td>
                <td>RS 125.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Tomato and Cheese/125"><strong> Tomato and Cheese</strong></td>
                <td>RS 125.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Veg Manchurian/120"><strong> Veg Manchurian</strong></td>
                <td>RS 120.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Chilly Cheese/130"><strong> Chilly Cheese</strong></td>
                <td>RS 130.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Chilly Mushroom/130"><strong> Chilly Mushroom</strong></td>
                <td>RS 130.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Veg Choupsey/130"><strong> Veg Chopsey</strong></td>
                <td>RS 130.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Honey Chilly Cauliflower/120"><strong> Honey Chilly Cauliflower</strong></td>
                <td>RS 120.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Veg Spring Rolls/130"><strong> Veg Spring Rolls</strong></td>
                <td>RS 130.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Special Chinese Platter/180"><strong> Spl Chinese Platter</strong></td>
                <td>RS 180.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Marghritta/190"><strong> Marghritta</strong></td>
                <td>RS 190.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Mushroom Corn Delight/220"><strong> Mushroom Corn Delight</strong></td>
                <td>RS 220.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Sizzling Paneer Tikka/230"><strong> Sizzling Paneer Tikka</strong></td>
                <td>RS 230.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Chilly Paneer Pizza/230"><strong> Chilly Paneer Pizza</strong></td>
                <td>RS 230.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Onion Masala Dosa/120"><strong> Onion Masala Dosa</strong></td>
                <td>RS 120.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Paneer Dosa/140"><strong> Paneer Dosa</strong></td>
                <td>RS 140.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Paper Dosa/140"><strong> Paper Dosa</strong></td>
                <td>RS 140.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Paper Masala Dosa/160"><strong> Paper Masala Dosa</strong></td>
                <td>RS 160.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Rawa Plain Dosa/120"><strong> Rawa Plain Dosa</strong></td>
                <td>RS 120.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Rawa Masala Dosa/130"><strong> Rawa Masala Dosa</strong></td>
                <td>RS 130.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Rawa Onion Masala Dosa/140"><strong> Rawa Onion Masala Dosa</strong></td>
                <td>RS 140.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Mix Veg Uttapam/120"><strong> Mix Veg Uttapam</strong></td>
                <td>RS 120.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Sambhar Vada/100"><strong> Sambhar Vada</strong></td>
                <td>RS 100.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Idli Sambhar/90"><strong> Idli Sambhar</strong></td>
                <td>RS 90.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Onion Tomato Uttapam/120"><strong> Onion Tomato Uttapam</strong></td>
                <td>RS 120.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="South Indian Platter/180"><strong> South Indian Platter</strong></td>
                <td>RS 180.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Mutter Mushroom/180"><strong> Mutter Mushroom</strong></td>
                <td>RS 180.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Karahi Paneer/185"><strong> Karahi Paneer</strong></td>
                <td>RS 185.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Paneer Tikka Butter Masala/190"><strong> Paneer Tikka Butter Masala</strong></td>
                <td>RS 190.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Sebz Seekh Kebab/130"><strong> Sebz Seekh Kebab</strong></td>
                <td>RS 130.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Butter Roti/20"><strong> Butter Roti</strong></td>
                <td>RS 20.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Lacha Prantha/30"><strong> Lacha Prantha</strong></td>
                <td>RS 30.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Plain Naan/30"><strong> Plain Naan</strong></td>
                <td>RS 30.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Lahsuni Naan/30"><strong> Lahsuni Naan</strong></td>
                <td>RS 40.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Paneer Naan/48"><strong> Paneer Naan</strong></td>
                <td>RS 48.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                ...
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Paneer Prantha/42"><strong> Paneer Prantha</strong></td>
                <td>RS 42.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Spl Hari Mirch Prantha/42"><strong> Spl Hari Mirch Prantha</strong></td>
                <td>RS 42.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
                <tr>
                <td><input type="checkbox" id="select" name="select[]" value="Amritsari Kulcha/42"><strong> Amritsari Kulcha</strong></td>
                <td>RS 42.00</td>
                <td align="center">
                <input type="text" class="form-control item" id="item" name="item[]" value=0></td>
                </tr>
