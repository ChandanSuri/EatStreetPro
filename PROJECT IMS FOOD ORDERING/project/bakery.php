...
<div class="row">
	...
	<div class="panel panel-default">
      ...
      <img src="images/sahni.jpg" alt="Sahni Bakery" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 >Sahni Bakery</h3>
        <p>
        	<address>
        	No.22, Bhupindra Road,<br/>
          Phatak, Patiala,<br/>
          Punjab 147001.
        	</address>
        </p>
        <p><a href="sahni's.php?rest_id=27&categ_id=6" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
  </div>
    </div>
  </div>
  ...
  <div class="panel panel-default">
		<div class="panel-body">
        <img src="images/dunkin_donuts.jpg" alt="Dunkin Dognuts" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 style="position:center">Dunkin Dognuts</h3>
        <p>
        	<address>
        ...
        <p><a href="dunkin_donuts.php?rest_id=28&categ_id=6" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
    </div>
  </div>
</div>
