...
<div class="container">
	...
	<h2 id="heading">Chinese</h2>
	</div>
</div>
<div class="jumbotron">
<div class="container">
<div class="row">
	<div class="col-md-4 col-md-offset-2 col-sm-5 col-xs-10">
	<div class="panel panel-default">
		<div class="panel-body">
      <img src="images/yochina.jpg" alt="Yo! China" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 >Yo! China</h3>
        <p>
        	<address>
        ...
        <p><a href="Yo China.php?rest_id=17&categ_id=4" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
  </div>
    </div>
  </div>
	...
	<div class="panel panel-default">
		<div class="panel-body">
		<img src="images/red_dragon.jpg" alt="Red Dragon" class="restaurants img-circle img-responsive">
      <div class="caption">
        <h3 style="position:center">Red Dragon</h3>
        <p>
        	<address>
        	22no. Phatak,<br/>
        ...
        <p><a href="red_dragon.php?rest_id=18&categ_id=4" class="btn btn-primary" role="button">Go To</a> </p>
      </div>
    </div>
  </div>
</div>
