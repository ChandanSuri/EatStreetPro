...
<div class="container">
  <div class="row">
     <div class="col-md-12">
      <div class="progress">
         <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="67" aria-valuemin="0" aria-valuemax="100" style="width: 67%">
...
<div class="panel panel-warning">
        ...
        <div class="panel-body">
          ...
          if(!isset($_SESSION['username']))
          {
            ...
            echo '<tr>';
            echo '<h4>When do you want to pay?</h4><br/>';
            echo '</tr>';
            echo '<tr>';
            echo '<form method="POST" action="confirmed.php" role="form">';
            echo '<input type="radio" name="pay_type" value="On Delivery" onchange="order();">&nbsp;&nbsp;Cash On Delivery</tr><br/>';
            echo '<tr><input type="radio" name="pay_type" value="Pick Up" onchange="order();">&nbsp;&nbsp;Take Away</tr><br/>';
            echo '<input type="submit" id="confirm" class="btn btn-primary" value="Confirm Order" disabled>';
            echo '</form>';
                }
          ?>
          </table>
